						...
						<div class="carousel-item active">
							...
							<div class="row">
								...
								<div class="detail-box">
									...
									<p>
									Ми щасливі запросити вас долучитися до нашого фармацевтичного каталогу, де ви зможете знайти найкращі медичні продукти та ліки для вашого здоров'я та добробуту. 
									Приєднуйтеся до нашої спільноти, де якість і ваше здоров'я є нашим пріоритетом.
									</p>
									<div>
									<a href="/shop">
										Перейти
	...
	<section class="feature_section  layout_padding my_body2">
		...
		<div class="feature_container">
			...
			<div class="detail-box">
				...
				<p>
				Наш фармацевтичний магазин має офіційну державну ліцензію, гарантуючи вашу безпеку та надійність
				</p>
			</div>
			</div>
			<div class="box">
		...
		<section class="about_section layout_padding">
				...
				<div class="img-box">
					<img class="my-img" src="{{ asset('assets/images/about-us.jpg') }}" alt="">
				</div>
				<div class="detail-box">
					<p>
					Ми - ваш надійний партнер у догляді за здоров'ям, завжди готові забезпечити вас високоякісними ліками та медичними засобами. 
					</p>
					<p>
					Наша місія - піклуватися про ваше благополуччя.
					</p>
				</div>
				</div>
		</section>
